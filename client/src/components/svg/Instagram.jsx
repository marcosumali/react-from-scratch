    ...
    return (
      <div>
        ...
        <g>
          ...
          <path fill={color} d="M214.618,80.326H100.034c-10.477,0-19,8.523-19,19v116c0,10.477,8.523,19,19,19h114.584c10.477,0,19-8.523,19-19v-116
          ...
          <rect fill={color} x="183.583" y="111.812" width="20.615" height="18.911"/>
          <circle fill={color} cx="157.326" cy="164.946" r="20.324"/>
          <path fill={color} d="M189.745,164.856c0,17.904-14.514,32.418-32.418,32.418s-32.418-14.514-32.418-32.418l0.044-14.445h-14.497v53.761h93.743
